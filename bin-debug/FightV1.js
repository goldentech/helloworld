var FightV1 = (function (_super) {
    ...
    p.countDamage = function (basicDamage, attackDamage, dodge) {
        var damage = 0;
    ...
    p.monsterMove = function (sword, monster2, bar1, bar2, damage, life1, life2) {
        ...
        while (1) {
            if (j < fightProcess.process1.length) {
                ...
                egret.Tween.get(sword).wait(900 * 2 * j).to({ x: 375, y: 300, rotation: 0 }, 30).call(function () {
            ...
            if (j < fightProcess.process2.length) {
                ...
                egret.Tween.get(monster2).wait(900 * (2 * j + 1)).to({ x: 100, y: 300, rotation: 0 }, 30).call(function () {
        ...
        var fightResult = new egret.TextField();
...
//# sourceMappingURL=FightV1.js.map